  ...
  if($job_count > 0){
    ...
    echo '<div class="row" id="'.$profile_id.'">';
      echo '<div class="col-sm-12">';
        ...
        echo '<hr>';
        echo '<div class="panel-footer" style="margin-top:-25px;">';
        echo "<div>"; ?><label><button type='button' class="btn btn-success btn-lg appBtn" id='approval_Yes_<?php echo $profile_id;?>' onclick='approve(id);' >Approve</button></label><?php echo "</div>";
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
